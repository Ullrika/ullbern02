...
The expected value of the proportion of successes is $E(\frac{Y|x_i}{n_i})=\frac{n_ip(x_i)}{n_i}=p(x_i)$.
...
Solving the equation for Bayes rule analyticaly quickly gets cumbersome. There are alternatives. 
