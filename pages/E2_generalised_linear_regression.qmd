...
Write **your own code** to estimate the parameters using maximum likelihood. You are not allowed to use ready available functions for maximum likelihood estimation, but you can use built in functions for optimisation. 
...
1. Upload the csv file with the samples and the code to estimate the model and generate samples in the assignment *Exercise: Generalised Linear Models* on Canvas. 

2. Use your private git repository for the course and invite Ullrika to the git (username Ullrika). Push your code to git and send a link to the repository in the assignment *Exercise: Generalised Linear Models* on Canvas.
