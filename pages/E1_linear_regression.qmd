...
You are all familiar with Python, and some of you have worked with R before.   

A skill for a computational scientist is to master different programming languages. R has a friendly environment for data analysis, so take the opportunity to explore that as well. 
...
Upload the code for the function together with the three predictions in the assignment *Exercise: Linear Regression* on Canvas. 
