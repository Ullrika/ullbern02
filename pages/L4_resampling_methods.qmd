...
In this lecture, I present cross-validation and bootstrapping and ways to estimate variance in predictions or a quantity of interest. I want you to understand the difference between common approaches.  
...
Here we assume you have access to all data. A second validation or hold-out set (which in principle can be considered as hidden from the analyst) can be used to test a model after fitting and model selection has been done.  
