...
- use it via [Posit Cloud](https://login.posit.cloud) (no installation needed, just create an account) and create reports (notebooks) using [Quarto](https://quarto.org/). The most robust option. 
...
- use it on your desktop by [installing R and RStudio](https://posit.co/download/rstudio-desktop/)  on your computer. I do not have the time to support computer-specific issues that might arise. 
...
1. Upload the code for the function together with the three predictions in the assignment *Exercise: Regression* on Canvas. 

2. Create a private git repository for the course and invite Ullrika to the git (username Ullrika). Push your code to git and send a link to the repository in the assignment *Exercise: Regression* on Canvas.

Write your name and date in the beginning of code and, if applicable, the name of your collaborator. 

The exercises/computer labs are designed to be carried out the same day as the lecture. We encourage you to do the exercise on the time assigned for it, to get support from tutors. 
