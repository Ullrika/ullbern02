...
(@) For polynomial models with degree 1 up to 4, derive the mean square error of prediction for the training and testing data sets, respectively. **Note: It is ok to use built in functions for polynomial regression.**
...
Using maximum likelihood based on all data, my estimate of the parameter is $\hat{\beta}_1 = -0.03244$. 
...
When taking the standard deviation of the bootstrap sample of the slope parameter I get `r sd(bootstrap_sample)`. What do you get?
...
(3) Submit a report. This can be done in two ways: 

- Save the report as PDF and code in runnable format, and upload in the assignment *Exercise: Resampling* on Canvas. 

- Use your private git repository or colab for the course and invite Ullrika (git username is Ullrika). Push your code to git and send a link to the repository in the assignment *Exercise: Resampling* on Canvas.
