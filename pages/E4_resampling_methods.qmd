...
(4) Submit a report. This can be done in two ways: 

- Upload the report in the assignment *Exercise: Resampling* on Canvas. 

- Use your private git repository for the course and invite Ullrika to the git (username Ullrika). Push your code to git and send a link to the repository in the assignment *Exercise: Resampling* on Canvas.
