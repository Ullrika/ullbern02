...
- Save the report and code, and upload in the assignment *Exercise: Resampling* on Canvas. 

- Use your private git repository or colab for the course and invite Ullrika to the git (username Ullrika). Push your code to git and send a link to the repository in the assignment *Exercise: Resampling* on Canvas.
